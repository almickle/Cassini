...
void
PointLight::SpawnControlWindow() noexcept
{
  if (ImGui::Begin("Light")) {
    ...
    ImGui::SliderFloat(
      "Intensity", &cbData.diffuseIntensity, 0.01f, 2.0f, "%.2f");
...
void
PointLight::Draw(Graphics& gfx) const noexcept(!IS_DEBUG)
{
...
void
PointLight::Bind(Graphics& gfx, DirectX::FXMMATRIX view) const noexcept
{
