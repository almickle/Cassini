...
float4 main( float3 worldPos : Position, float3 n : Normal, float2 tc : TextureCoordinate, uint instanceID : SV_InstanceID ) : SV_Target
{
    ...
    return float4( instanceBuffer[instanceID].modelColor * lighting, 1.0f );
}