...
static ID3D11DeviceContext* g_pd3dDeferredContext = nullptr;
...
// Setup Dear ImGui style
	...
	while (!done) {
		...
		scene->UpdateScene(*gfx, gui->GetSceneSize(), *manager);
		// 3D Rendering //
...
void
CreateDeferredContext() {
	g_pd3dDevice->CreateDeferredContext(0, &g_pd3dDeferredContext);
}
bool
CreateDeviceD3D(HWND hWnd)
{
